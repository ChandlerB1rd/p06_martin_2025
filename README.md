...
Replication and extension of Martin (2025) using OptionMetrics and CRSP data to construct the SVIX index, reproduce the paper's forecasting results, and evaluate the robustness of SVIX as a predictor of future equity returns.
